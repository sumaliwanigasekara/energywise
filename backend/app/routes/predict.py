...
def predict():
    ...
    payload = {
        ...
        "washer_hours_per_month": float(_from_profile("washer_hours_per_month", 0)),
        "heater_hours_per_month": float(_from_profile("heater_hours_per_month", 0)),
        "other_hours_per_month": float(_from_profile("other_hours_per_month", 2)),
        "weather": weather,
    }
    ...
    prediction = Prediction(
        ...
        ac_hours_per_month=payload["ac_hours_per_month"],
        ac_tons=payload["ac_tons"],
        fridge_count=payload["fridge_count"],
        washer_hours_per_month=payload["washer_hours_per_month"],
        heater_hours_per_month=payload["heater_hours_per_month"],
        other_hours_per_month=payload["other_hours_per_month"],
